    ...
    implements Continuation
{
        ...
        throws Exception
    {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView webview1, String s1)
            {
                super.onLoadResource(webview1, s1);
        ...
        webview.addJavascriptInterface(new Object() {
            ...
            public void setValue(String s1)
            {
                try
                {
                    tcs.trySetResult(new JSONArray(s1));
                    return;
                }
        ...
        Object obj = val$contentType.get();
        String s = null;
        if (obj != null)
        {
            s = ((String)val$contentType.get()).split(";")[0];
        }
        webview.loadDataWithBaseURL(val$url.toString(), (String)val$content.get(), s, null, null);
        return tcs.getTask();
    }
