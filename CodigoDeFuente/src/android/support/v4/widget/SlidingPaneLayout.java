...
_L1:
        ...
        k2 = 0;
_L8:
        if (k2 >= j2) goto _L5; else goto _L4
_L4:
        View view1;
        LayoutParams layoutparams1;
        view1 = getChildAt(k2);
        layoutparams1 = (LayoutParams)view1.getLayoutParams();
        if (view1.getVisibility() != 8) goto _L7; else goto _L6
_L6:
...
_L2:
        ...
        continue; /* Loop/switch isn't completed */
_L7:
        if (layoutparams1.weight <= 0.0F) goto _L10; else goto _L9
_L9:
        f += layoutparams1.weight;
        if (layoutparams1.width == 0) goto _L11; else goto _L10
_L10:
