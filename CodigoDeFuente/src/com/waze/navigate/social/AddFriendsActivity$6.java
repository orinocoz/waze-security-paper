...
class val.friend
    implements android.view.sActivity._cls6
{
    ...
    {
        AddFriendsActivity.access$3(AddFriendsActivity.this, val$friendLayoutInListLayout);
        int ai[] = new int[1];
        ai[0] = val$friend.getID();
        String s = AddFriendsActivity.access$0(AddFriendsActivity.this).getLanguageString(DisplayStrings.DS_PS_REMOVED);
