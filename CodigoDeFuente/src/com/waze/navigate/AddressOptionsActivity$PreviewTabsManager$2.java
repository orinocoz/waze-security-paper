...
class this._cls1
    implements com.waze.anager._cls2
{
    ...
    {
        int _tmp = AddressOptionsActivity.access$5(cess._mth1(this._cls1.this));
        if (s != null)
        {
            if (s.contains("tel:"))
            {
                AddressOptionsActivity.access$2(cess._mth1(this._cls1.this), "ADS_INFO_PHONE_CLICKED");
                ...
                ((AddressOptionsActivity)AddressOptionsActivity.access$6().get()).runOnUiThread(new Runnable() {
                    ...
                    final AddressOptionsActivity.PreviewTabsManager._cls2 this$2;
            ...
            {
                this$2 = AddressOptionsActivity.PreviewTabsManager._cls2.this;
                intent = intent1;
                super();
            }
                });
            ...
            {
                AddressOptionsActivity.access$2(cess._mth1(this._cls1.this), "ADS_INFO_URL_CLICKED");
            } else
