...
class this._cls0
    implements android.view.y._cls26
{
    ...
    {
        AddressPreviewActivity.access$10(AddressPreviewActivity.this).eraseAddressItem(AddressPreviewActivity.access$6(AddressPreviewActivity.this));
        setResult(32783);
