...
/* anonymous class */
    class AddressOptionsActivity.PreviewTabsManager._cls2
        implements com.waze.WzWebView.WebViewUrlOverride
    {
        ...
        {
            int _tmp = AddressOptionsActivity.access$5(AddressOptionsActivity.PreviewTabsManager.access$1(AddressOptionsActivity.PreviewTabsManager.this));
            if (s != null)
            {
                if (s.contains("tel:"))
                {
                    AddressOptionsActivity.access$2(AddressOptionsActivity.PreviewTabsManager.access$1(AddressOptionsActivity.PreviewTabsManager.this), "ADS_INFO_PHONE_CLICKED");
                    Intent intent1 = new Intent("android.intent.action.DIAL", Uri.parse(s.substring(s.indexOf("tel:"), s.length())));
                    ((AddressOptionsActivity)AddressOptionsActivity.access$6().get()).runOnUiThread(intent1. new AddressOptionsActivity.PreviewTabsManager._cls2._cls1());
                    return true;
                }
                if (s.startsWith("waze://?open_url"))
                {
                    AddressOptionsActivity.access$2(AddressOptionsActivity.PreviewTabsManager.access$1(AddressOptionsActivity.PreviewTabsManager.this), "ADS_INFO_URL_CLICKED");
                } else
