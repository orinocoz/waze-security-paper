    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/waze/navigate/AddressOptionsActivity$3

/* anonymous class */
    class AddressOptionsActivity._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            (new Handler()).postDelayed(new AddressOptionsActivity._cls3._cls1(), i);
        }
