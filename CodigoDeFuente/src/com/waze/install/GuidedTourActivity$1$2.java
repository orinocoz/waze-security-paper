...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                com.waze.social.facebook.FacebookWrapper.IOnAuthorizeCompletedListener ionauthorizecompletedlistener = new GuidedTourActivity._cls1._cls1();
                FacebookWrapper.getInstance().SignIn(GuidedTourActivity.this, ionauthorizecompletedlistener, true);
                return;
            } else
            {
                GuidedTourActivity._cls1._cls2 _lcls2 = new GuidedTourActivity._cls1._cls2();
                FacebookWrapper.getInstance().authorize(GuidedTourActivity.this, _lcls2, true);
                return;
            }
        }
        ...
        // Unreferenced inner class com/waze/install/GuidedTourActivity$1$1

/* anonymous class */
        class GuidedTourActivity._cls1._cls1
