    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (MyProfileActivity.access$11(_fld0) != null && MyProfileActivity.access$11(_fld0).length() > 0)
        {
            MyProfileActivity.access$9(_fld0).SuggestUserNameRequest(null, null, MyProfileActivity.access$11(_fld0));
        }
    }
    ...
    // Unreferenced inner class com/waze/profile/MyProfileActivity$9

/* anonymous class */
    class MyProfileActivity._cls9
        implements TextWatcher
    {
        ...
        public void afterTextChanged(Editable editable)
        {
            ...
            {
                aEvent = new MyProfileActivity._cls9._cls1();
            }
