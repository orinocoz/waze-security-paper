    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (NameYourWazerPopup.access$4(_fld0) != null && !NameYourWazerPopup.access$4(_fld0).equals(""))
        {
            NameYourWazerPopup.access$3(_fld0).SuggestUserNameRequest(null, null, NameYourWazerPopup.access$4(_fld0));
        }
        r.cancel();
    }
...
/* anonymous class */
    ...
    // Unreferenced inner class com/waze/profile/NameYourWazerPopup$4$1

/* anonymous class */
    class NameYourWazerPopup._cls4._cls1 extends TimerTask
    {
        ...
        public void run()
        {
            AppService.getMainActivity().runOnUiThread(new NameYourWazerPopup._cls4._cls1._cls1());
        }
