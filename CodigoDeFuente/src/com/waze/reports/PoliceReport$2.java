    ...
    implements android.view.tener
{
    ...
    {
        if (PoliceReport.access$0(PoliceReport.this) == 0)
        {
        ...
        {
            PoliceReport.access$1(PoliceReport.this, 0);
            String s;
            ...
            {
                s = nativeManager.getLanguageString(DisplayStrings.DS_POLICE_OVISIBLEU);
            }
