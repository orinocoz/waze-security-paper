    ...
    implements android.view.
{
    ...
    {
        stop();
        if (RoadClosureReport.access$0(RoadClosureReport.this) == 2)
        {
        ...
        {
            RoadClosureReport.access$1(RoadClosureReport.this, 2);
            String s = nativeManager.getLanguageString(DisplayStrings.DS_EVENT);
