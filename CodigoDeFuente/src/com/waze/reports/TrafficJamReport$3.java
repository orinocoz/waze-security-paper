    ...
    implements android.view.r
{
    ...
    {
        if (TrafficJamReport.access$0(TrafficJamReport.this) == 2)
        {
        ...
        {
            TrafficJamReport.access$1(TrafficJamReport.this, 2);
            String s = nativeManager.getLanguageString(DisplayStrings.DS_COMPLETE_STANDSTILL);
