    ...
    implements android.view.r
{
    ...
    {
        if (TrafficJamReport.access$0(TrafficJamReport.this) == 0)
        {
        ...
        {
            TrafficJamReport.access$1(TrafficJamReport.this, 0);
            String s = nativeManager.getLanguageString(DisplayStrings.DS_MODERATE_TRAFFIC);
