...
class eImage
    implements android.view._cls2._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        {
            PlacePhotoGallery.access$7(_fld0, i);
            return;
        }
    }
...
/* anonymous class */
    class PlacePhotoGallery._cls2 extends WazePagerAdapter
    {
        ...
        public Object instantiateItem(ViewGroup viewgroup, int i)
        {
            ...
            imagebutton.setOnClickListener(vi. new PlacePhotoGallery._cls2._cls5());
            if (s == null || s.isEmpty())
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/waze/reports/PlacePhotoGallery$2$2

/* anonymous class */
        class PlacePhotoGallery._cls2._cls2
            implements android.view.View.OnClickListener
        {
