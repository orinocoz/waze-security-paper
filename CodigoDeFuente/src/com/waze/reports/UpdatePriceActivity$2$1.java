    ...
    implements android.view._cls2._cls1
{
    ...
    // Unreferenced inner class com/waze/reports/UpdatePriceActivity$2

/* anonymous class */
    class UpdatePriceActivity._cls2
        implements com.waze.navigate.DriveToNativeManager.ProductListener
    {
        ...
        private void setEditTextMaxLength(Product product)
        {
            ...
            do
            {
                ...
                ainputfilter[0] = new android.text.InputFilter.LengthFilter(product.formats[i].length());
        ...
        public void onComplete(Product product)
        {
            ...
            findViewById(0x7f09079d).setOnClickListener(new UpdatePriceActivity._cls2._cls1());
            ai = (new int[] {
