...
public final class BitmapDescriptorFactory
{
    ...
    public static BitmapDescriptor fromAsset(String s)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(jH().bs(s));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromBitmap(Bitmap bitmap)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(jH().b(bitmap));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromFile(String s)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(jH().bt(s));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
    ...
    public static BitmapDescriptor fromPath(String s)
    {
        ...
        try
        {
            bitmapdescriptor = new BitmapDescriptor(jH().bu(s));
        }
        catch (RemoteException remoteexception)
        {
            throw new RuntimeRemoteException(remoteexception);
