...
public final class PlusShare
{
    public static class Builder
    {
        ...
        public Intent getIntent()
        {
            ...
            hn.a(flag3, "Call-to-action buttons are only available for URLs.");
            ...
            hn.a(flag4, "The content URL is required for interactive posts.");
            ...
            hn.a(flag, "Must set content URL or content deep-link ID to use a call-to-action button.");
