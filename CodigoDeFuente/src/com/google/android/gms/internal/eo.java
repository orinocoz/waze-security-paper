...
public final class eo
{
    ...
    public static void execute(Runnable runnable)
    {
        ...
        {
            ev.c((new StringBuilder()).append("Too many background threads already running. Aborting task.  Current pool size: ").append(getPoolSize()).toString(), rejectedexecutionexception);
        }
    }
