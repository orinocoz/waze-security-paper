...
public class GoogleAnalyticsTracker
{
    ...
    {
        Event event = new Event(eventStore.getStoreId(), s, s1, s2, s3, i, parent.getResources().getDisplayMetrics().widthPixels, parent.getResources().getDisplayMetrics().heightPixels);
    ...
    {
        while (dispatchPeriod < 0 || !handler.postDelayed(dispatchRunner, 1000 * dispatchPeriod) || !debug) 
        {
            return;
        }
    ...
    public void addItem(Item item)
    {
        ...
        Object obj = (Map)itemMap.get(item.getOrderId());
        if (obj == null)
        {
            obj = new HashMap();
    ...
    public boolean setCustomVar(int i, String s, String s1, int j)
    {
        try
        {
            CustomVariable customvariable = new CustomVariable(i, s, s1, j);
    ...
    public void trackTransactions()
    {
        ...
        do
        {
            ...
            eventStore.putEvent(event);
            Map map = (Map)itemMap.get(transaction.getOrderId());
            if (map != null)
            {
