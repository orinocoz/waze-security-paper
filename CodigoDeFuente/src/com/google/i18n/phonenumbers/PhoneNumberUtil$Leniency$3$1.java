    ...
    implements pingChecker
{
    ...
    final roupsRemainGrouped this$0;

    public boolean checkGroups(PhoneNumberUtil phonenumberutil, pingChecker pingchecker, StringBuilder stringbuilder, String as[])
    {
        return PhoneNumberMatcher.allNumberGroupsRemainGrouped(phonenumberutil, pingchecker, stringbuilder, as);
    }
...
/* anonymous class */
    static final class PhoneNumberUtil.Leniency._cls3 extends PhoneNumberUtil.Leniency
    {
        ...
        boolean verify(Phonenumber.PhoneNumber phonenumber, String s, PhoneNumberUtil phonenumberutil)
        {
            ...
            {
                return PhoneNumberMatcher.checkNumberGroupingIsValid(phonenumber, s, phonenumberutil, new PhoneNumberUtil.Leniency._cls3._cls1());
            }
        }
