    ...
    public void onClick(View view)
    {
        ...
        } else
        {
            ...
            if (!session.isOpened())
            {
                ...
                {
                    boolean flag = context instanceof ContextWrapper;
                    ner = null;
                    if (flag)
                    {
                        android.content.Context context1 = ((ContextWrapper)context).getBaseContext();
                        boolean flag1 = context1 instanceof Activity;
                        ner = null;
                        if (flag1)
                        {
                            ner = new com.facebook.t((Activity)context1);
                        }
                    }
                }
                if (ner != null)
