    ...
    implements Serializable
{
    ...
    private static AccessToken createFromBundle(List list, Bundle bundle, AccessTokenSource accesstokensource, Date date)
    {
        ...
        {
            return new AccessToken(s, date1, list, null, accesstokensource, new Date());
        }
    }
    ...
    static AccessToken createFromRefresh(AccessToken accesstoken, Bundle bundle)
    {
        ...
        } else
        {
            ...
            String s = bundle.getString("access_token");
            return createNew(accesstoken.getPermissions(), accesstoken.getDeclinedPermissions(), s, date, accesstoken.source);
        }
    }
    ...
    static AccessToken createFromWebBundle(List list, Bundle bundle, AccessTokenSource accesstokensource)
    {
        ...
        boolean flag = Utility.isNullOrEmpty(s2);
        ArrayList arraylist = null;
        if (!flag)
        {
            arraylist = new ArrayList(Arrays.asList(s2.split(",")));
        }
        return createNew(list, arraylist, s, date, accesstokensource);
    }
...
_L3:
    ...
    {
        ArrayList arraylist = bundle.getStringArrayList(s);
        if (arraylist == null)
        {
