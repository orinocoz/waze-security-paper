...
_L6:
        ...
        if (!jsonobject.has("fbsdk:create_object")) goto _L7; else goto _L10
_L10:
        processGraphObjectProperty(s, jsonobject.toString(), keyvalueserializer, flag);
        return;
_L4:
label0:
        {
...
_L2:
        ...
        throws JSONException, IOException
    {
        ...
        do
        {
            ...
            arraylist.add(s2);
            map.put(s2, new Attachment(this, obj));
        } while (true);
    }
...
_L1:
    ...
    private static List typedListFromResponse(Response response, Class class1)
    {
        ...
        {
            if ((graphobjectlist = graphmultiresult.getData()) != null)
            {
