    ...
    implements Serializable
{
    ...
    {
        SerializationProxyV1 serializationproxyv1;
        if (obj instanceof SerializationProxyV1)
        {
            if (Utility.areObjectsEqual((serializationproxyv1 = (SerializationProxyV1)obj).accessToken, accessToken) && Utility.areObjectsEqual(serializationproxyv1.applicationId, applicationId))
            {
                return true;
            }
        }
