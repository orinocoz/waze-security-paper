    ...
    implements Serializable
{
    ...
    private void logAppDeactivatedEvent(AppEventsLogger appeventslogger, long l)
    {
        ...
        aobj[0] = Integer.valueOf(getQuantaIndex(l));
        bundle.putString("fb_mobile_time_between_sessions", String.format("session_quanta_%d", aobj));
...
_L2:
        if (l1 > 1000L)
        {
            interruptionCount = 1 + interruptionCount;
        }
