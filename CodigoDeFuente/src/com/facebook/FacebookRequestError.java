...
_L4:
        ...
        s3 = jsonobject3.optString("error_user_msg", null);
        s2 = jsonobject3.optString("error_user_title", null);
        flag1 = jsonobject3.optBoolean("is_transient", false);
        boolean flag = true;
_L8:
        if (!flag)
        {
        ...
        return new FacebookRequestError(i, j, k, s, s1, s2, s3, flag1, jsonobject2, jsonobject, obj, httpurlconnection);
_L5:
        if (jsonobject2.has("error_code") || jsonobject2.has("error_msg")) goto _L7; else goto _L6
_L6:
        boolean flag2 = jsonobject2.has("error_reason");
        s = null;
        s1 = null;
        s2 = null;
        s3 = null;
...
_L9:
        FacebookRequestError facebookrequesterror = new FacebookRequestError(i, -1, -1, null, null, null, null, false, jsonobject1, jsonobject, obj, httpurlconnection);
