...
_L4:
    ...
    public static Intent createPlatformActivityIntent(Context context, String s, String s1, int i, String s2, Bundle bundle)
    {
        ...
        String s3 = Utility.getMetadataApplicationId(context);
...
_L2:
    ...
    public static Exception getExceptionFromErrorData(Bundle bundle)
    {
        ...
        String s1 = bundle.getString("error_description");
        if (s1 == null)
        {
    ...
    private static int getLatestAvailableProtocolVersionForAppInfoList(Context context, List list, int ai[])
    {
        ...
        do
        {
            ...
            i = getLatestAvailableProtocolVersionForAppInfo(context, (NativeAppInfo)iterator.next(), ai);
        } while (i == -1);
        return i;
    }
    ...
    public static Bundle getSuccessResultsFromIntent(Intent intent)
    {
        ...
        if (!isVersionCompatibleWithBucketedIntent(i) || bundle == null)
        {
            return bundle;
        } else
        {
    ...
    static 
    {
        Integer ainteger[] = new Integer[11];
        ainteger[0] = Integer.valueOf(0x13354a2);
        ainteger[1] = Integer.valueOf(0x1335433);
        ainteger[2] = Integer.valueOf(0x13353e4);
        ainteger[3] = Integer.valueOf(0x13353c9);
        ainteger[4] = Integer.valueOf(0x133529d);
        ainteger[5] = Integer.valueOf(0x1335124);
        ainteger[6] = Integer.valueOf(0x13350ac);
        ainteger[7] = Integer.valueOf(0x1332d23);
        ainteger[8] = Integer.valueOf(0x1332b3a);
        ainteger[9] = Integer.valueOf(0x1332ac6);
        ainteger[10] = Integer.valueOf(0x133060d);
