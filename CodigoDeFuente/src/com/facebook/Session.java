...
_L2:
        ...
        if ((graphmultiresult = (GraphMultiResult)response.getGraphObjectAs(com/facebook/model/GraphMultiResult)) == null || ((graphobjectlist = graphmultiresult.getData()) == null || graphobjectlist.size() == 0)) goto _L1; else goto _L3
_L3:
        ArrayList arraylist;
